...
public interface AttachmentRepository extends JpaRepository<Attachment, Long> {
    ...
    @Transactional
    @Modifying
    @Query("UPDATE Attachment a SET a.ownerId = :#{#doc.ownerId}, a.isDeleted = :#{#doc.isDeleted}, a.attDescr = :#{#doc.attDescr}, a.issueDate = :#{#doc.issueDate}, a.expiryDate = :#{#doc.expiryDate}, a.fileUrl = :#{#doc.fileUrl} WHERE a.id = :#{#doc.id}")
