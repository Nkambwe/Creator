package com.pbu.attachments.repositories;
...
public interface IdentificationRepository extends JpaRepository<Identification, Long> {
    ...
    @Transactional
    @Modifying
    @Query("UPDATE Identification i SET i.ownerId = :#{#doc.ownerId}, i.idNo = :#{#doc.idNo}, i.isDeleted = :#{#doc.isDeleted}, i.issueDate = :#{#doc.issueDate}, i.expiryDate = :#{#doc.expiryDate}, i.fileUrl = :#{#doc.fileUrl} WHERE i.id = :#{#doc.id}")
